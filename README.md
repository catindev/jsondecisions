...
Декларативный движок принятия решений по заранее подготовленным JSON-фактам. Входит в туже экоститему технологий, что и `jsonspecs` - декларативные DSL для описания бизнес-процессов.

Библиотека предназначена для ситуаций, где нужно не валидировать данные, а **выбрать нормализованный бизнес-исход** по набору уже собранных признаков.
